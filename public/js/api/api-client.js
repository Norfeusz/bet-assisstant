...
export async function loadDatabaseLeagues(country = null) {
    try {
        const url = country 
            ? `/api/database/leagues?country=${encodeURIComponent(country)}`
 ...
 */
export async function loadBackgroundJobs() {
    try {
...
export async function updateRateLimit() {
    try {
        ...
        document.getElementById('rate-limit-remaining').textContent = remaining;
        document.getElementById('rate-limit-total').textContent = total;
        document.getElementById('rate-limit-reset').textContent = resetTime.toLocaleTimeString('pl-PL');
